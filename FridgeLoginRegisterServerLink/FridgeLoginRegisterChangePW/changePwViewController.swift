...
class changePwViewController: UIViewController {
    ...
    func eyeBtnClicked(textField: UITextField, button: UIButton) {
        if pwWhetherEye == true {
            ...
            let continueAction = UIAlertAction(title: "네, 계속합니다.", style: UIAlertAction.Style.default, handler: {ACTION in textField.isSecureTextEntry = true
    ...
    @IBAction func pwEyeBtnClicked(_ sender: UIButton) {
        eyeBtnClicked(textField: pwTextField, button: pwEyeButton)
        
    }
    
    @IBAction func pwCheckEyeBtnClicked(_ sender: UIButton) {
        eyeBtnClicked(textField: pwCheckTextField, button: pwCheckEyeButton)
    }
